...
| Tamaño | `check-added-large-files --maxkb=500` | binarios en el historial. El límite es 500 KB porque por encima de eso lo que se cuela suele ser un artefacto de modelo, y del historial no sale |
